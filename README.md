...
- Practical experience with retrieval‑augmented generation (RAG), vector search, prompt/context engineering, and fine‑tuning workflows.
- Skilled in designing and deploying secure, cost‑optimized, and highly available applications on AWS.
- Strong foundation in OOP, Python, databases, and modern JavaScript/frontend development.
- Proven track record building high‑load systems with complex architectures, supporting both horizontal and vertical scaling.
